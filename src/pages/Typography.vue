  ...
  <q-page class="g-pa-xl">
    <section class="q-mb-xl">
      ...
      <p class="text-body2">
        ...
        possimus nihil molestias sapiente necessitatibus dolor saepe invntore,
    ...
    <section class="q-mb-xl">
      ...
      <p class="text-weight-medium text-strike">
        Lorem Ipsum is simply dummy text of the printing and typesetting
        industry.
      </p>
      <p class="text-weight-bolder text-center">
        Lorem Ipsum is simply dummy text of the printing and typesetting
        industry.
      </p>
    </section>
